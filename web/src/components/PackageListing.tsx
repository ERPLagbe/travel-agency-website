        ...
        <div className="min-h-screen bg-gray-50 py-16">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    {/* Mobile Filter Panel */}
                    <div className={`lg:hidden fixed inset-0 z-50 transition-all duration-300 ease-in-out ${isMobileFilterOpen
                            ? 'opacity-100 visible'
                        ...
                        />
                        {/* Drawer */}
                        <div className={`absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl transform transition-transform duration-300 ease-in-out ${isMobileFilterOpen
                                ? 'translate-x-0'
                                : 'translate-x-full'
                            }`}>
                            <div className="p-6">
